...
"[project]/src/app/bw-admin/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function AdminDashboard() {
    ...
    const bookingsCollection = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$provider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemoFirebase"])({
        "AdminDashboard.useMemoFirebase[bookingsCollection]": ()=>firestore ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["collection"])(firestore, 'bookings') : null
    }["AdminDashboard.useMemoFirebase[bookingsCollection]"], [
        firestore
    ]);
    const servicesCollection = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$provider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemoFirebase"])({
        "AdminDashboard.useMemoFirebase[servicesCollection]": ()=>firestore ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["collection"])(firestore, 'services') : null
    }["AdminDashboard.useMemoFirebase[servicesCollection]"], [
        firestore
    ]);
    const usersCollection = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$provider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemoFirebase"])({
        "AdminDashboard.useMemoFirebase[usersCollection]": ()=>firestore ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["collection"])(firestore, 'users') : null
    }["AdminDashboard.useMemoFirebase[usersCollection]"], [
        firestore
    ]);
    const { data: bookingsData, isLoading: bookingsLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$firestore$2f$use$2d$collection$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCollection"])(bookingsCollection);
    const { data: servicesData, isLoading: servicesLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$firestore$2f$use$2d$collection$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCollection"])(servicesCollection);
    const { data: usersData, isLoading: usersLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$firestore$2f$use$2d$collection$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCollection"])(usersCollection);
    ...
    const totalRevenue = bookings.filter((b)=>b.paymentStatus === 'Paid').reduce((acc, b)=>{
...
_s(AdminDashboard, "d/nvkp7BIADEUI1Y69zadgLx25w=", false, function() {
    return [
...
//# sourceMappingURL=src_90201c1a._.js.map